		...
		<div id="middle">
            ...
            <div class="col_destinazioni" >
				...
				<li>
					...
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Bath.pdf">Centre Contact Details.</a> <br>
                ...
                <li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Bedford.pdf">Centre Contact Details.</a> <br>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/tabellemusei/BEDFORD_tabellemusei.pdf">Museums</a><br>
                ...
                <li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Cambridge.pdf">Centre Contact Details.</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/CAMBRIDGE_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
				...
				<li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
					<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Canterbury.pdf">Centre Contact Details.</a> <br>
				...
				<li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Cheltenham.pdf">Centre Contact Details.</a> <br>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/tabellemusei/CHELTENHAM_tabellemusei.pdf">Museums</a><br>
                         <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Cheltenham_2012_2_Week_Programme.pdf">Cheltenham 2 Week Programme</a><br> 
                         <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Cheltenham_2012_3_Week_Programme.pdf">Cheltenham 3 Week Programme</a><br>
                ...
                <div class="dhtmlgoodies_question">CHESTER</div>
					<div class="dhtmlgoodies_answer">
					<div>
					<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Chester.pdf">Centre Contact Details.</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/CHESTER_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
                ...
                <div class="dhtmlgoodies_question">EDINBURGH</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Edinburgh.pdf">Centre Contact Details.</a> <br>
                        ...
                        <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Edinburgh 2012 - 2 Week Activity Programme.pdf">Edinburgh 2 Week Programme</a><br> 
                        <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Edinburgh 2012 - 3 Week Activity Programme.pdf">Edinburgh 3 Week Programme</a>
					</div>
					</div>
                </li>
                <li>
                <div class="dhtmlgoodies_question">LEICESTER</div>
					<div class="dhtmlgoodies_answer">
					<div>
					<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Leicester.pdf">Centre Contact Details.</a> <br>
                    ...
                    <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Leicester_2012_2_Week_Activity_Programme.pdf">Leicester 2 Week Programme</a><br> 
                    <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Leicester_2012_3_Week_Activity_Programme.pdf">Leicester 3 Week Programme</a><br>
               	...
               	<li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Greenwich.pdf">Centre Contact Details.</a> <br>	
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/GREENWICH_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
                ...
                <div class="dhtmlgoodies_question">LONDON ROEHAMPTON</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Roehampton.pdf">Centre Contact Details.</a> <br>
                ...
                <div class="dhtmlgoodies_question">LOUGHBOROUGH</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/LOUGHBOROUGH_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
                        ...
                        <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Loughborough_2012_2_Week_Activity_Programme.pdf">Loughborough 2 Week Programme</a><br> 
                        <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Loughborough_2012_3_Week_Activity_Programme.pdf">Loughborough 3 Week Programme</a><br>
                ...
                <div class="dhtmlgoodies_question">NORWICH</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Norwich.pdf">Centre Contact Details.</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/NORWICH_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
                ...
                <div class="dhtmlgoodies_question">PLYMOUTH</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Plymouth.pdf">Centre Contact Details.</a> <br>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/tabellemusei/PLYMOUTH_tabellemusei.pdf">Museums</a><br>
                         <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Plymouth_2012_2_Week_Activity_Programme.pdf">Plymouth 2 Week Programme</a><br> 
                         <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/Plymouth_2012_3_Week_Activity_Programme.pdf">Plymouth 3 Week Programme</a><br>                                      
                ...
                <div class="dhtmlgoodies_question">PORTSMOUTH</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/Portsmouth_Factsheet_2012.pdf">Campus Fact Sheet</a> <br>
                ...
                <li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/details/Standrews.pdf">Centre Contact Details.</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/STANDREWS_FACTSHEET_2011.pdf">Campus Fact Sheet</a> <br>
			...
			<div class="col_destinazioni" >
                ...
                <li>
					...
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/DUBLIN_FACTSHEET 2012.pdf">Campus Fact Sheet</a><br>
...
<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/activity_program/Dublin_2012_2_Week_Activity_Programme.pdf">Dublin 2 Week Programme</a> <br>
                ...
                <div class="dhtmlgoodies_question">MALTA</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/MALTA.pdf">Campus Fact Sheet</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/Malta_2012_2_Week_Activity_Programme.pdf">Malta 2 Week Programme</a>
					</div>
					</div>
                    </li>
                ...
                <div class="dhtmlgoodies_question">TORONTO</div>
					...
					<div>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS CANADA - Toronto 2 Weeks.pdf">Toronto 2 Week Programme</a>                
					</div>
					</div>
                    </li>
				...
				<ul class="icodoc">
					...
					<div>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston 2 Weeks.pdf">Boston 2 Week Programme</a> <br> 
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 2 Weeks.pdf">Boston-New York 2 Week Programme</a> <br> 
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York-Boston 2 Weeks.pdf">New York-Boston 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 3 Weeks.pdf">Boston-New York 3 Week Programme</a>        
					</div>
					</div>
                    </li>
                ...
                <div class="dhtmlgoodies_question">LOS ANGELES</div>
					...
					<div>
						...
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Los Angeles 2 Weeks.pdf">Los Angeles 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Los Angeles-San Francisco 3 Weeks.pdf">Los Angeles-San Francisco 3 Week Programme</a>                                                                 
					</div>
					</div>
                    </li>
                   ...
                   <div class="dhtmlgoodies_question">NEW YORK RIDER</div>
					...
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/NYRider.pdf">Campus Fact Sheet</a> <br>
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York Rider 2 Weeks.pdf">New York Rider 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York Rider 3 Weeks.pdf">New York Rider 3 Week Programme</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 2 Weeks.pdf">Boston-New York 2 Week Programme</a> <br> 
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York-Boston 2 Weeks.pdf">New York-Boston 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 3 Weeks.pdf">Boston-New York 3 Week Programme</a>                                                        
					</div>
                ...
                <div class="dhtmlgoodies_question">NEW YORK DREW</div>
					<div class="dhtmlgoodies_answer">
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/NY DREW_FACTSHEET_2012.pdf">Campus Fact Sheet</a> <br>
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York Drew 2 Weeks.pdf">New York Drew 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York Drew 3 Weeks.pdf">New York Drew 3 Week Programme</a> <br>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 2 Weeks.pdf">Boston-New York 2 Week Programme</a> <br> 
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - New York-Boston 2 Weeks.pdf">New York-Boston 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Boston-New York 3 Weeks.pdf">Boston-New York 3 Week Programme</a>                                                          
					</div>
                   ...
                   <div class="dhtmlgoodies_question">FLORIDA</div>
					...
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>	pdf/factsheet/FLORIDA.pdf">Campus Fact Sheet</a> <br>
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Florida 2 Weeks.pdf">Florida 2 Week Programme</a>
					</div>
					</div>  
				</LI>
                    <li>
					...
					<div>
						<img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/factsheet/sanfrancisco.pdf">Campus Fact Sheet</a> <br>
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - San Francisco 2 Weeks.pdf">San Francisco 2 Week Programme</a> <br> 
                                                <img src="<?php echo base_url(); ?>images/iconpdf.jpg" style="margin:4px;"><a class="blu" href="<?php echo base_url(); ?>pdf/activity_program/PLUS USA - Los Angeles-San Francisco 3 Weeks.pdf">Los Angeles-San Francisco 3 Week Programme</a>         
					</div>
					</div>
                    </li>  
