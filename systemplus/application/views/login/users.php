	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="login-box-body">
				...
				<form id="frmLogin" action="<?php echo base_url(); ?>index.php/vauth/userpost" method="post" >
					<div class="form-group has-feedback">
						<input tabindex=1 type="text" class="required noerror form-control" placeholder="Email address" name="login_name" id="login_name" />
					</div>
					<div class="form-group has-feedback">
					...
					<div class="row">
						<div class="col-xs-8 mr-top-7">
							<a href="<?php echo site_url() ?>/vauth/userforgotpassword">I forgot my password</a><br>
						</div>
						<!-- /.col -->
						<div class="col-xs-4">
		...
		<script>
			$(function () {
				$("#frmLogin").validate({
					...
					messages: {
						login_name: "Please enter your email address",
