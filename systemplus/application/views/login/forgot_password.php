	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="login-box-body">
				...
				<form id="frmLogin" action="<?php echo base_url(); ?>index.php/vauth/forgotpassword<?php echo ( $called_from != '' ) ? '/'.$called_from : ''; ?>" method="post" >
					<div class="form-group has-feedback">
						<input tabindex=1 type="text" class="required noerror form-control" placeholder="Username" name="txtUsername" id="txtUsername" />
					</div>
					<div class="row">
						<div class="col-xs-8 mr-top-7">
							<?php if ( $called_from == "agents" ) { ?>
								<a href="<?php echo base_url();?>index.php/vauth/agents">Login</a><br>
							<?php } else { ?>
								<a href="<?php echo base_url();?>index.php/vauth/backoffice">Login</a><br>
							<?php } ?>
						</div>
						<!-- /.col -->
						<div class="col-xs-4">
