...
<body class=login>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<a class="phone-title" href="<?php echo base_url(); ?>index.php/backoffice"><img src="<?php echo base_url(); ?>img/logo-mobile.png" alt="plus-ed.com" height="22" width="70" /></a>
	...
	<section id="login" class="container_12 clearfix">
		...
		<form action="<?php echo base_url(); ?>index.php/backoffice/login" method="post" class="box validate">
			...
			<?php
				...
				<?php
                                ...
                                $back_office_login_msg = $this->session->flashdata('back_office_login_msg');
                                if(!empty($back_office_login_msg)){
				?>
					<div class="alert error">
						<span class="icon"></span><span class="close">x</span>
						<strong>Error!</strong> <?php echo $back_office_login_msg;?>
					</div>
				<?php
					}
			?>
				...
				<div class="form-box">
					...
					<div class="row">
						<label for="login_pw">
							...
							<small><a href="<?php echo base_url().'index.php/backoffice/forgotpassword'?>" id="">Forgot it?</a></small>
						</label>
						<div>
