	...
	if ($locked == '1') {
		if ($initTemp == 'USA') {
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-us detaila" style="width: 88%; margin: auto">
				...
				foreach ($detSTD as $STD) {
					...
					<tr>
						...
						<td><span><?php echo $STD["booked_pax_name"] ?></span></td>
						<td><span><?php echo $STD["booked_pax_surname"] ?></span></td>
						<td><span><?php if ($STD["booked_pax_gender"] == 'M') {
				echo 'Male';
			}
			elseif ($STD["booked_pax_gender"] == 'F') {
				echo 'Female';
			} ?></span></td>
						<td><span><?php echo date("d/m/Y", strtotime($STD["booked_pax_dob"])); ?></span></td>
						<td><span><?php echo $STD["booked_pax_passport_no"] ?></span></td>
						<td><span>--</span></td>
					</tr>
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-us">
				...
				<tr><td style="height:20px;">&nbsp;</td></tr>
				<tr>
					<td>Upon arrival date, <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?> students and group leaders will be met by a Plus Representative at the Airport and transferred to <?php echo $booking_detail["nome_centri"]; ?>. This transfer has been arranged and organised by Plus Ltd.<br />Students and group leaders will be met at <?php echo $booking_detail["nome_centri"]; ?> by the residential campus manager and be allocated a room.<br /><br /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>There is a PLUS emergency mobile number which is available 24 / 7. The number is 07956 218 226.<br />Accommodation address:<br /><?php echo $booking_detail["nome_centri"]; ?><br />Departure date: <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?>.<br />Students and group leaders will be transferred from <?php echo $booking_detail["nome_centri"]; ?>. This transfer has been arranged and organised by PLUS Ltd.<br /><br /></td>
				</tr>
				<tr>
		...
		elseif ($initTemp == 'UKIR') {
			...
			<table cellpadding="0" cellspacing="0" class="grande">
				...
				<tr>
					<td>This is to confirm that the following students and group leader(s) from <?php echo $agency["businessname"] . ', ' . $agency["businesscountry"]; ?> are part of a group enrolling on an English language short course programme for <?php echo $booking_detail["enrol_number_of_week"] <= 1 ? $booking_detail["enrol_number_of_week"] . ' week' : $booking_detail["enrol_number_of_week"] . ' weeks'; ?>, from <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?> to <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?> , taking place at  <?php echo $booking_detail["nome_centri"] . ', ' . $booking_detail["located_in"]; ?>.
					</td>
				</tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
			</table>
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-us">
				<tr><td style="height:20px;">&nbsp;</td></tr>
				<tr>
					<td>Upon arrival date, <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?> students and group leaders will be met by a Plus Representative at the Airport and transferred to <?php echo $booking_detail["nome_centri"]; ?>. This transfer has been arranged and organised by Plus Ltd.<br /><br />Students and group leaders will be met at <?php echo $booking_detail["nome_centri"]; ?> by the residential campus manager and be allocated a room.<br /><br /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>There is a PLUS emergency mobile number which is available 24 / 7. The number is 07956 218 226.<br /><br /><br /><strong>Accommodation address:</strong><br /><?php echo $booking_detail["nome_centri"]; ?><br /><br />Departure date is <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?>, students and group leaders will be transferred from <?php echo $booking_detail["nome_centri"]; ?> to the airport. This transfer has been arranged and organised by PLUS Ltd.<br /><br /></td>
				</tr>
				<tr>
		...
		elseif ($initTemp == 'MAL') {
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-mal">
				...
				<tr><td colspan="2" style="text-align:right;">London, <?php echo $booking_detail['enrol_template'] ? date('d M Y', strtotime($booking_detail['enrol_template'])) : date("d M Y"); ?></td></tr>
		...
		elseif ($initTemp == 'UKIRGLSTD' || $initTemp == 'UKIRSTDSTD' || $initTemp == 'UKIRSTDST') {
			...
			<table cellpadding="0" cellspacing="0" class="grande">
				<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
				<tr><td style="text-align:left;">London, <?php echo $booking_detail['enrol_template'] ? date('d M Y', strtotime($booking_detail['enrol_template'])) : date("d M Y"); ?></td></tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
				<tr>
					<td align="center"><b style="font-size:11pt;">To whom it may concern</b></td>
				</tr>
				<tr>
					<td>This is to confirm that the following students from <?php echo $agency["businessname"] . ', ' . $agency["businesscountry"]; ?> are part of a group enrolling on an English Language Course programme for <?php echo $booking_detail["enrol_number_of_week"] <= 1 ? $booking_detail["enrol_number_of_week"] . ' week' : $booking_detail["enrol_number_of_week"] . ' weeks'; ?>, from <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?> to <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?> , taking place at  <?php echo $booking_detail["nome_centri"] . ', ' . $booking_detail["located_in"]; ?>.
					</td>
				</tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
				<tr>
					<td>Campus address: <?php echo $booking_detail["address"] . ',' . $booking_detail['post_code']; ?></td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" class="grande grande-us">
				<tr>
		...
		?>
			...
			<table cellpadding="0" cellspacing="0" class="grande">
				<tr>
					<td>Upon arrival date <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?>, the group will be met by a PLUS representative at the Airport and transferred to <?php echo $booking_detail["nome_centri"]; ?>. This transfer will be organised and arranged by PLUS. <br /><br />
						Students and group leader will be met at <?php echo $booking_detail["nome_centri"]; ?> by the residential campus manager and be allocated a room.<br /><br /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
					Departure date is <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?>, they will be transferred from <?php echo $booking_detail["nome_centri"]; ?> to the airport. These transfers have been arranged and organised by PLUS Ltd.<br /><br /></td>
		</tr>
		<tr>
...
foreach ($detGL as $single) {
	if ($single["booked_pax_surname"] != "") {
		if (isset($uriArray[$single['booked_pax_id']])) {
			if ($uriArray[$single['booked_pax_id']] == 'UKIR') {
				?>
				<table cellpadding="0" cellspacing="0" class="grande">
					<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
					<tr><td style="text-align:right;">London, <?php echo $single['booked_template_date'] ? date("d M Y", strtotime($single['booked_template_date'])) : date("d M Y"); ?></td></tr>
					<tr><td style="height:20px;">&nbsp;</td></tr>
					<tr>
						<td align="center"><b style="font-size:11pt;">To whom it may concern</b></td>
					</tr>
			...
			elseif ($uriArray[$single['booked_pax_id']] == 'USA') {
				?>
				<table cellpadding="0" cellspacing="0" class="grande grande-us">
					<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
					<tr><td style="text-align:right;">London, <?php echo $single['booked_template_date'] ? date("d M Y", strtotime($single['booked_template_date'])) : date("d M Y"); ?></td></tr>
			...
			elseif ($uriArray[$single['booked_pax_id']] == 'MAL') {
				...
				<table cellpadding="0" cellspacing="0" class="grande grande-mal">
					...
					<tr><td colspan="2" style="text-align:right;">London, <?php echo $single['booked_template_date'] ? date("d M Y", strtotime($single['booked_template_date'])) : date("d M Y"); ?></td></tr>
					<tr><td colspan="2" style="height:20px;">&nbsp;</td></tr>
					<tr>
						<td colspan="2" align="center"><b style="font-size:25pt; font-family: cursive,sans-serif,Arial">Certificate of Enrolment</b><br /><br /></td>
					</tr>
				...
				<table cellpadding="0" cellspacing="0" class="grande grande-us detaila" style="width: 88%; margin: auto">
					...
					<tr>
						<td><span><?php echo $single["booked_pax_name"] ?></span></td>
						<td><span><?php echo $single["booked_pax_surname"] ?></span></td>
						<td><span><?php echo date("d/m/Y", strtotime($single["booked_pax_dob"])); ?></span></td>
						<td><span><?php if ($single["booked_pax_gender"] == 'M') {
				echo 'Male';
			}
			elseif ($single["booked_pax_gender"] == 'F') {
				echo 'Female';
						...
						<td><span>GL</span></td>
						<td><span><?php echo $single["booked_pax_passport_no"] ?></span></td>
						<td><span>--</span></td>
					</tr>
				</table>
			...
			elseif ($uriArray[$single['booked_pax_id']] == 'UKIRGLSTD') {
				?>
				<table cellpadding="0" cellspacing="0" class="grande">
					<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
					<tr><td style="text-align:left;">London, <?php echo $single['booked_template_date'] ? date("d M Y", strtotime($single['booked_template_date'])) : date("d M Y"); ?></td></tr>
					<tr><td style="height:20px;">&nbsp;</td></tr>
					<tr>
						<td align="center"><b style="font-size:11pt;">To whom it may concern</b></td>
					</tr>
			...
			elseif ($uriArray[$single['booked_pax_id']] == 'UKIRSTDSTD') {
				?>
				<table cellpadding="0" cellspacing="0" class="grande">
				<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
				...
				<tr>
					<td>This is to confirm that
						...
						?><?php echo $single["booked_pax_name"] ?> <?php echo $single["booked_pax_surname"] ?>, born on the <?php echo date("d/m/Y", strtotime($single["booked_pax_dob"])); ?>, Passport no. <?php echo $single["booked_pax_passport_no"] ?> is part of a group of students participating in an English language course for <?php echo $booking_detail["enrol_number_of_week"] <= 1 ? $booking_detail["enrol_number_of_week"] . ' week' : $booking_detail["enrol_number_of_week"] . ' weeks'; ?>, taking place at <?php echo $booking_detail["nome_centri"] . ', ' . $booking_detail["located_in"]; ?>.
						<br /><br />
						From: <?php echo date("d/m/Y", strtotime($booking_detail["enrol_arrival_date"])); ?><br/>
						To: <?php echo date("d/m/Y", strtotime($booking_detail["enrol_departure_date"])); ?><br /><br />
						Campus address: <?php echo $booking_detail["address"].','.$booking_detail['post_code']; ?><br /><br />
			...
			elseif ($uriArray[$single['booked_pax_id']] == 'UKIRSTDST') {
				?>
				<table cellpadding="0" cellspacing="0" class="grande">
				<tr><td style="height:100px;"><img src="http://www.plus-ed.com/vision_ag/img/top_visas.gif" border="0" /></td></tr>
				<tr><td style="height:20px;">&nbsp;</td></tr>
