...
<head>
<meta charset="utf-8">
<title>plus-ed.com</title>
</head>
<body style="margin-left: 0px;margin-top: 0px;margin-right: 0px;margin-bottom: 0px;">
<div style="width:100%;max-width:1024px;margin:0 auto;position:relative;display:block;" id="warpper">
    <div style="width:100%;margin:0 ;float:left;" id="warpper_in"><!-- border:solid 1px #fab1b3; -->
    	<div class="top_header" style="background-color: #587691;padding: 10px 0 10px 10px;width:100%;max-width:1024px;height:100%;float:left;">
        ...
        <div style="width:100%;max-width:1024px;height:100%;float:left;height:70px;" class="fotter">
