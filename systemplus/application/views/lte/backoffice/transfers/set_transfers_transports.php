...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        <form name="allbuses" id="allbuses" method="POST" action="<?php echo base_url(); ?>index.php/transfers/plusedConfirmTransfersBuses">
          ...
          <table class="table table-bordered table-striped">
              ...
              <tbody>
                <tr>
                  <td>
                    <?php 
                    if($in_out=="inbound") { 
                        $airportName = str_replace("to/from","",$airport);
                        $airportName = ucwords(str_replace("inbound","",$airportName));
                        ?>
                      <textarea id="pickup_place" name="pickup_place" class="form-control" ><?php echo $airportName ?> to <?php echo $pickupPlace ?></textarea>         
                    <?php } else { 
                        $airportName = str_replace("to/from","",$airport);
                        $airportName = ucwords(str_replace("outbound","",$airportName));
                        ?>
                      <textarea id="pickup_place" name="pickup_place" class="form-control" ><?php echo $pickupPlace ?> to <?php echo $airportName ?></textarea>         
                    <?php } ?>
                  </td>
                  <td>
                    <input type="text" id="pickup_time" name="pickup_time" class="form-control" value="" style="width:60px;" />
                  </td>
                </tr>
              </tbody>
              <tfoot>
            ...
            <?php   } ?>
                    <tr>
                      ...
                      <td style="text-align:right;"><input style="text-align:right;" class="silverinputborder" type="text" readonly value="0" name="supcost" id="supcost" /> <?php echo $bb["jn_currency"]?></td>
                      <td></td>
                    </tr> 
                    <tr>
                      <td colspan="2">&nbsp;</td>
