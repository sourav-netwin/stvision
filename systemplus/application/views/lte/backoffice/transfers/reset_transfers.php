...
$(document).ready(function() {
    $("#resetTra").click(function(){
        confirmAction("Are you sure you want to reset all the lost transfers?", 
        function(c)
        {
            if(c)
                window.location.replace("<?php echo base_url(); ?>index.php/transfers/actionResetLostTrasfers/");
        }, true, true);
    });
});
</script>