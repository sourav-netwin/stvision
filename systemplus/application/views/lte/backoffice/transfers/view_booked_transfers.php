    ...
    <div class="col-xs-12">
      <div class="box box-warning">
        <div class="box-header col-sm-12">
            ...
            <form id="box_transport" name="box_transport" action="<?php echo base_url(); ?>index.php/transfers/viewBookedTransfers" method="POST">
        ...
        <div class="box-body">
            <table id="dataTableStaffPriority" class="table datatable table-bordered table-striped" style="width:99.98%">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary min-wd-24" data-toggle="tooltip" data-original-title="View detail" id="code_<?php echo $exc["ptt_buscompany_code"]?>" href="<?php echo base_url(); ?>index.php/transfers/busTraDetail/code_<?php echo $exc["ptt_buscompany_code"]?>">
...
$(document).ready(function() {
    ...
    $(".view_bus_list").click(function(){
        ...
        $.post( "<?php echo base_url(); ?>index.php/transfers/busDetailForExcursion/"+busCode, function( data ) {
