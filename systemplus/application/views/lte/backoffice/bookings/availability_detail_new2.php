                ...
                <div class="col-sm-8">
                    <ul class="nav nav-pills" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#d" style="cursor: default;" data-toggle="pill">
                                <span class="glyphicon glyphicon-calendar"></span> Availability on <?php echo $campusname ?> from <?php echo date("m/d/Y", strtotime($datein)) ?> to <?php echo date("m/d/Y", strtotime($dateout)) ?>
                            </a>
                        </li>
                    </ul>
                </div>
                                                ...
                                                while (strtotime($datecycle) <= strtotime($dateout)) {
                                                    ...
                                                    $weekDay = date("D", strtotime($datecycle));
                                                        if(in_array($weekDay, $weekEndDays))
                                                           $weekends = "weekends ";
                                                    ?>
                                                <th  class="<?php echo $weekends; if (in_array(strtotime($datecycle), $dateArr)) { ?>text-info info<?php } ?>" ><span <?php if (strtotime($datecycle) == strtotime($datechoose)) { ?>class="text-danger"<?php } ?>><?php echo substr(date("D", strtotime($datecycle)), 0,1)." ".date("m/d", strtotime($datecycle)); ?></span></th>
                                                    <?php
                                                ...
                                                <tr id="riga_<?php echo $contarighe ?>">
                                                    ...
                                                    while (strtotime($datecycle) <= strtotime($dateout)) {
                                                        ...
                                                        if ($datecycle >= $book["arrival_date"] and $datecycle < $book["departure_date"]) {
                                                            //echo "-Numero<br>";
                                                            ?>
                                                            <td  class="text-center <?php echo $weekends;?> <?php echo $statusBTS; ?>" title="<?php echo $book["contaPieni"] ?>"><input class="contapax form-control nobbg" id="<?php echo $_REQUEST["accomodation"][$a] ?>_pax_<?php echo $contarighe ?>_<?php echo strtotime($datecycle) ?>" type="text" readonly value="<?php echo $book["num_in"] ?>"></td>
                                                            <?php
                                                        } else {
                                                            //echo "-Zero<br>";
                                                            ?>
                                                            <td  class="text-center <?php echo $weekends;?>" title="<?php echo $book["contaPieni"] ?>"><input class="contapax form-control nobbg" id="<?php echo $_REQUEST["accomodation"][$a] ?>_pax_<?php echo $contarighe ?>_<?php echo strtotime($datecycle) ?>" type="text" readonly value="0"></td>
                                                            <?php
                                                        }
                                                        $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                    }
                                                ...
                                                <tr id="riga_<?php echo $contarighe ?>" class="overnight">
                                                    ...
                                                    while (strtotime($datecycle) <= strtotime($dateout)) {
                                                        ...
                                                        if ($datecycle >= $book["arrival_date"] and $datecycle < $book["departure_date"]) {
                                                            //echo "-Numero<br>";
                                                            ?>
                                                            <td  class="text-center <?php echo $statusBTS ?>" title="<?php echo $book["contaPieni"] ?>"><input class="contapax form-control nobbg" id="<?php echo $_REQUEST["accomodation"][$a] ?>_pax_<?php echo $contarighe ?>_<?php echo strtotime($datecycle) ?>" type="text" readonly value="<?php echo $book["num_in"] ?>"></td>
                                                            <?php
                                                        } else {
                                                            //echo "-Zero<br>";
                                                            ?>
                                                            <td  class="text-center" title="<?php echo $book["contaPieni"] ?>"><input class="contapax form-control nobbg" id="<?php echo $_REQUEST["accomodation"][$a] ?>_pax_<?php echo $contarighe ?>_<?php echo strtotime($datecycle) ?>" type="text" readonly value="0"></td>
                                                            <?php
                                                        }
                                                        $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                    }
                                            ...
                                            <tr class="rigaAvail">
                                                ...
                                                foreach ($simcalendar[$a] as $cAva) {
                                                    ...
                                                    $weekDay = date("D", strtotime($datecycle));
                                                        ...
                                                        $weekends = "weekends ";
                                                    ?>
                                                    <td class="<?php echo $weekends;?>"><input id="<?php echo $_REQUEST["accomodation"][$a] ?>_totava_<?php echo strtotime($datecycle) ?>" type="text" class="form-control nobbg" readonly value="<?php echo $cAva["totale"] ?>"></td>
                                                    <?php
                                                    $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                }
                                                ?>	
                                            ...
                                            <tr class="avalRow">
                                                ...
                                                while (strtotime($datecycle) <= strtotime($dateout)) {
                                                    ...
                                                    $weekDay = date("D", strtotime($datecycle));
                                                        ...
                                                        $weekends = "weekends ";
                                                    ?>
                                                    <td class="text-center <?php echo $weekends;?>"><input class="form-control nobbg" type="text" readonly id="<?php echo $_REQUEST["accomodation"][$a] ?>_leftava_<?php echo strtotime($datecycle) ?>" value="0"></td>
                                                        <?php
                                                        $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                    }
                                                    ?>	
