...
<table id="buscodes_dt" class="table table-bordered table-striped vertical-middle"> <!-- OPTIONAL: with-prev-next -->
        <thead>
            <tr>
                <th>Bus Code</th>
                <th>Transfer Date</th>
        ...
        <tbody>
            ...
            foreach ($detBusCodes as $bus) {
                ...
                <tr>
                    ...
                    <td class="center">
                        <a data-gravity="s" class="btn btn-xs btn-primary grey dialogbtn" id="code_<?php echo $bus["ptt_buscompany_code"] ?>" target="_blank" href="<?php echo base_url(); ?>index.php/backoffice/busTraDetail/code_<?php echo $bus["ptt_buscompany_code"] ?>" original-title="View detail"><i class="fa fa-eye" style="font-size:14px;"></i></a>
                    </td>									
                </tr>
                <?php
            }
