      ...
      <div class="box">
        ...
        <div class="box-body">
            <form enctype="multipart/form-data" method="post" class="no_validate" id="frmTeacher" action="">
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="selNationality"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="selSex"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="txtTelephone"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="selTeachYears"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="txtAddress"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="selPostCode"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="selCountry"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="txtAblilityFrom"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="txtAblilityTo"  >
                        ...
                        <div class="form-group row modal-header">
                            <h4 class="modal-title">Diplomas</h4>
                        </div>
                        <div class="form-group row">
                                <label class="col-sm-3 control-label" for="selDiplomas"  >
                        ...
                        <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-6"  >
                                    <input <?php echo (empty($formData['ta_other_diploma']) ? '' : 'checked');?> type="checkbox" name="chkOther" id="chkOther">
                                    &nbsp;
                                    <label for="chkOther">Other diplomas</label>
                                    
                                    <input class="form-control" type="text" placeholder="If other, please specify" id="txtOtherDiploma" name="txtOtherDiploma" value="<?php echo set_value('txtOtherDiploma',  $formData['ta_other_diploma']);?>">
                                    <div class="error"><?php echo form_error('txtOtherDiploma');?></div>
                                </div>
                        </div>
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="cvFile"  >
                        ...
                        <div class="form-group row">
                                 <label class="col-sm-3 control-label" for="otherFile"  >
                        ...
                        <div class="form-group row">
                                <label class="col-sm-3 control-label" for="passportOrIdCard"  >
                        ...
                        <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-9"  >
                                    ...
                                    <input class="btn btn-danger" type="reset" id="btnCancel" name="btnCancel" value="Cancel" onclick="window.location.href='<?php echo base_url();?>index.php/teachers/<?php echo ($formData["ta_job_adv_sent"] ? "profilereview" : "review" );?>'" />
                                </div>
                        </div>
                    </form>
             </div>
        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="modal-header">
                    <h4 class="modal-title">Teachers other documents</h4>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="post" class="no_validate" id="frmTeacher" action="">
                        ...
                        <div class="row">
                            <div class="col-sm-offset-3 col-sm-9">
                                <input class="btn btn-primary" type="button" id="btnAddFile" name="btnAddFile" value=" + Add File" />
                                <input class="btn btn-primary" type="button" id="btnUpload" name="btnUpload" value="Upload" />
                                <input class="btn btn-danger" type="reset" id="btnBackReview" name="btnBackReview" value=" << Back" onclick="window.location.href='<?php echo base_url();?>index.php/teachers/<?php echo ($formData["ta_job_adv_sent"] ? "profilereview" : "review" );?>'" />
...
<script>
    var pageHighlightMenu = "teachers/review";
    function iCheckInit(){
    ...
    $(document).ready(function() {
            ...
            function buildUploadFileControl(fileTitle,fileName){
                ...
                controlHTML += "     <label class='col-sm-3 control-label' for='txtFile_"+num+"' >";
                controlHTML += "            <strong>Upload file</strong>";
                controlHTML += "    </label>";
                controlHTML += "    <div class='col-sm-9' >";
                controlHTML += "            <div class='row'><div class='col-xs-4'><input type='text' placeholder='file title' data-num='"+num+"' id='txt_otherFile_"+num+"' name='txt_otherFile_"+num+"' class='fileTitleText form-control'   maxlength='100' value='"+fileTitle+"' />";
                controlHTML += "            </div></div><input type='file' class='oFiles pull-left' disabled='disabled' placeholder='other document "+num+"' name='otherFile_"+num+"' id='otherFile_"+num+"' >";
                ...
                controlHTML += "            <img title='Remove file' class='delete-icon-tuition pull-right' data-num='"+num+"' src='<?php echo base_url();?>/img/tuition/cross-circle.png' />";
                controlHTML += "    </div>";
                controlHTML += "</div>";
