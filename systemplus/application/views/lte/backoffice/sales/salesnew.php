...
<!--            <div class="box-header with-border">
            ...
            <div class="box-footer">
                ...
                <input id="inviaOPerc" name="inviaOPerc" type="button" value="Retrieve data perc(test)" class="btn btn-primary">
            </div>
            <!-- /.box-footer-->
          </div>
          <!--/.direct-chat -->
    ...
    $(document).ready(function() {
        ...
        $('#inviaO').on('click', function(e){
            ...
            if(centriChecked==0){
                ...
                if($("#dateStart").val()==""){
                    swal("Error","Please, select a from date");
                    return false;
                }else{
                    if($("#dateEnd").val()==""){
                        swal("Error","Please, select a to date");
                        return false;
                    }
                }		
            }
        ...
        $('#inviaOPerc').on('click', function(e){
            ...
            $('#retriveDataDiv').html('');
            $('<iframe/>', {
                'src' : siteUrl + "backoffice/salesDetailNewPerc/?" + passingData,
                'style' :'width:100%; height:100%;border:none;'
            }).appendTo('#retriveDataDiv');
            $("#dialog_modal_retrive_data").modal('show');;
            setTimeout(function(){
