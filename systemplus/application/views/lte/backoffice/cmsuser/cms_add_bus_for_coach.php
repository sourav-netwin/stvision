...
<div class="col-md-12">
    <div class="box">
        <div class="box-header with-border">
            <h4 class="box-title">Add new bus for <?php echo $company["tra_cp_name"]?></h4>
        ...
        <div class="box-body">
            ...
            <div class="row form-group">
                ...
                <div class="form-data col-sm-9 col-md-9 col-lg-4">
                    <input type="text" style="width:300px;" name="tra_bus_name" id="tra_bus_name" class="required form-control" value="">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-sm-3 col-md-3 col-lg-2">Seats:</div>
                <div class="col-sm-9 col-md-9 col-lg-4">
                    <input class="contastudenti form-control" data-type="spinner" name="tra_bus_seat" id="tra_bus_seat" value="0" min="0" max="100" />
                </div>
            </div>
            <div class="row form-group">
                <div class="col-sm-offset-3 col-lg-offset-2 col-sm-9 col-md-9 col-lg-4">
                    <input id="addbus" class="btn btn-primary" type="submit" value="Insert new bus" name="addbus" />
                </div>
            </div>
        </div>
    <!-- /.box-body -->
