            ...
            <div class="row form-group">
                ...
                <div class="form-data col-sm-9 col-md-9 col-lg-4">
                    <select id="tra_cp_server_type" name="tra_cp_server_type" class="form-control required" autocomplete="off">
                        ...
                        <option <?php echo ($CC['tra_cp_server_type'] == "Excursion" ? "selected" : "");?> value="Excursion">Excursion</option>
                        <option <?php echo ($CC['tra_cp_server_type'] == "Transfer" ? "selected" : "");?> value="Transfer">Transfer</option>
                        <option <?php echo ($CC['tra_cp_server_type'] == "Both" ? "selected" : "");?> value="Both">Both</option>
                    </select>
                </div>
            </div>
            <div class="row form-group">
