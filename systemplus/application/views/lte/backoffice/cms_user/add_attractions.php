        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" name="pat_entertainment_group" id="pat_entertainment_group" class="form-control" value="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" name="pat_student_price" id="pat_student_price" class="form-control" value="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" name="pat_adult_price" id="pat_adult_price" class="form-control" value="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <textarea style="width:600px;height:400px;" name="pat_desc" id="pat_desc" class="editor"></textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <textarea style="width:600px;height:400px;" name="pat_opening_time" id="pat_opening_time" class="editor"></textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <textarea style="width:600px;height:400px;" name="pat_notes_1" id="pat_notes_1" class="editor"></textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" id="pat_phone" name="pat_phone"  class="form-control">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" id="pat_email" name="pat_email"  class="form-control">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" id="pat_website" name="pat_website"  class="form-control">
              </div>
            </div>
          ...
          <div class="box-footer">
            <input id="modprofile" type="submit" value="Insert new attraction" name=modprofile class="btn btn-primary"/>
          </div>
          <!-- /.box-footer-->
        </div>
