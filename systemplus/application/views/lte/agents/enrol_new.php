...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-body">
                <form action="<?php echo base_url(); ?>index.php/enrol/insertGroup" name="enrolform" id="enrolform" class="grid12" method="POST">
                    ...
                    <input type="hidden" name="n_weeks" />
                    <!--                    <div class="form-group row">
                                            <div class="col-sm-3 col-md-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-data col-sm-9 col-md-9 col-lg-9 <?php echo (isset($form['error']['departure_date']) ? 'has-error' : ''); ?>" >
                            ...
                            <?php if (isset($form['error']['invertBookingDate'])) { ?>
                                <span class="invalid">
                                    Please Provide Valid dates, total nights between arrival and departure date cannot be less than 7 and higher than 25.
                                </span>
                            <?php } ?>
                        </div>
                    </div>
                        ...
                        <div class="form-data col-sm-9 col-md-9 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-lg-4 col-md-6">
                                    <input class="form-control sum_stud" type="text" autocomplete="off" class="" value="<?php echo @$form['data']['sum_stud']; ?>" readonly />
                                    <input class="sum_stud" type="hidden" name="sum_stud" value="<?php echo @$form['data']['sum_stud']; ?>" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 col-lg-3 col-md-4">
                                ...
                                <div class="col-sm-9 col-lg-4 col-md-6">
                                    <input class="form-control sum_gl" type="text" autocomplete="off" value="<?php echo @$form['data']['sum_gl']; ?>" readonly />
                                    <input class="sum_gl" type="hidden" name="sum_gl" value="<?php echo @$form['data']['sum_gl']; ?>" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 col-lg-3 col-md-4">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#writebook").click(function () {
            var totalNights = daydiff(parseDate($('#adate').val()), parseDate($('#ddate').val()));
            if (totalNights < 7) {
                swal("Error", "You have to select minimum 7 number of nights.");
                return false;
            }
            if (totalNights > 25) {
                swal("Error", "You can select maximum 25 nights.");
                return false;
            }
            var weeks = parseInt(getWeeks(totalNights));
            var extraNights = getExtraNights(weeks, totalNights);
            var arrivo_ok = 0;
            ...
            if ($(".sum_stud").val() == '' || $(".sum_stud").val() <= 0) {
                swal("Error", "No students enrolled!");
                return false;
            }
            if ($(".sum_gl").val() == '' || $(".sum_gl").val() <= 0) {
            ...
            if (extraNights > 0) {
                alert("You have added " + weeks + " week/s and " + extraNights + " extra night/s.");
            }
            if (arrivo_ok == 0) {
    ...
    function getWeeks(nights) {
        if (nights >= 7 && nights <= 11) {
            return 1;
        } else if (nights >= 12 && nights <= 18) {
            return 2;
        } else if (nights >= 19 && nights <= 25) {
            return 3;
        }
    }

    function getExtraNights(weeks, totalNights) {
        var weekDay = weeks * 7;
        if (totalNights > weekDay) {
            return totalNights - (weeks * 7);
        }
        return 0;
    }
