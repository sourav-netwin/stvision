...
<?php $this->load->view('plused_sidebar');?>		
	...
	$(document).ready(function() {
		...
		$( "li#mktplusj ul.sub li#mktplusj_2" ).addClass("current");			
	});
	</script>		
		<!-- Optional: Right Sidebar -->
		<div class="right-sidebar">
			<ul class=nav>
				<li class="current"><a href="#mpj_1"><span class="icon icon-list-alt"></span>Plus Junior Winter</a></li>
				...
				<li><a href="#mpj_10" href="javascript:void(0);"><span class="icon icon-list-alt"></span>Agents manual</a></li>
				<li><a href="#mpj_11" href="javascript:void(0);"><span class="icon icon-list-alt"></span>Students manual</a></li>
		...
		<h1 class="grid_12 margin-top">Plus Junior Winter</h1>
...
$directoryCENTRO="/var/www/html/www.plus-ed.com/vision_ag/downloads/winter/".strtolower(urlencode($cIR["nome_centri"]))."_".$cIR["id"]."/";
$directoryLINK="downloads/winter/".strtolower(urlencode($cIR["nome_centri"]))."_".$cIR["id"]."/";
$array_extimg=array('.pdf');
$arrayfile=array();
?>
								<ul>
...
$directoryCENTRO="/var/www/html/www.plus-ed.com/vision_ag/downloads/winter/".strtolower(urlencode($cMA["nome_centri"]))."_".$cMA["id"]."/";
$directoryLINK="downloads/winter/".strtolower(urlencode($cMA["nome_centri"]))."_".$cMA["id"]."/";
$array_extimg=array('.pdf');
$arrayfile=array();
?>
								<ul>
...
?>									
		...
		<div id="mpj_11">
							<h2 class="grid_12 margin-top">Students manual</h2>							
							<p class="grid_12">
