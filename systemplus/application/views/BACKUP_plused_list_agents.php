...
<?php //if($this->session->userdata('email')=="a.sudetti@gmail.com"){?>		
										<a data-gravity="s" id="agente_<?php echo $agent["id"]?>" class="button small grey tooltip mleft_10 openreminder" href="javascript:void(0);" original-title="Set agent reminder" style="margin-left:0;"><i class="icon-edit"></i></a>		
<?php
//}
?>											
									</td>
