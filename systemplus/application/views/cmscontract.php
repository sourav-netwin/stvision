		...
		$gross_salary=($salary*10.77)/100;
												...
												//	echo "<tr><td align=\"right\">";
													...
													Your period of continuous employment begins on <?php echo $mcontract['date_start']; ?><br><br>
														...
														You are employed as a <strong><?php echo $nome['type_contract']  ?></strong>  for a fixed term at <?php echo $mcontract['center_def']; ?>  which will end on <?php echo $dataend; ?>.  Either party may terminate this employment within this period by giving the notice detailed in the Notice section.<br><br>
														...
														Your salary will be paid at the rate of <?php echo $nome['salary']; ?> &pound; per week (including holiday pay of <?php echo $gross_salary; ?>  ) monthly by BACS.<br/><br/>
...
<br clear="all">
<img style="display:block:float:left;" src="<?php echo base_url(); ?>images/firma.jpg" />
