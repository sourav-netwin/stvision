...
<body style="font-size:10px;">
	<table cellpadding="0" cellspacing="0" class="grande">
		...
		<tr>
			...
			<?php switch ($detExc['pte_proforma_currency']){
				case "GBP":
			?>
		...
		<tr>
			<td colspan="2">
				<table class="corpopre">
					...
					<tr>
						<td><span><?php echo $detExc['pte_tot_pax']*1 - $detExc['pte_proforma_num_std']*1 ?> GL</span></td>
						<td>
							<span>Deposit received for group leaders enrolled for <?php echo $detExc['exc_length'] ?> excursion from <?php echo $detExc['exc_centro'] ?> to <?php echo $detExc['exc_excursion'] ?>.</span><br /><br /><br />
						</td>
						<td style="text-align:right"><span>0,00 <?php echo $detExc['pte_proforma_currency'] ?></span></td>
					</tr>
					<tr>
						<td><span><?php echo $detExc['pte_proforma_num_std']*1 ?> STD</span></td>
						<td>
							<span>Deposit received for students enrolled for <?php echo $detExc['exc_length'] ?> excursion from <?php echo $detExc['exc_centro'] ?> to <?php echo $detExc['exc_excursion'] ?>.</span><br /><br /><br />
						</td>
						<td style="text-align:right"><span><?php echo number_format(str_replace(",",".",$detExc['pte_proforma_price'])*$detExc['pte_proforma_num_std'],2,",",""); ?> <?php echo $detExc['pte_proforma_currency'] ?></span></td>
					</tr>					
					...
					<tr>
						...
						<td style="text-align:right;"><span><b><?php echo number_format(str_replace(",",".",$detExc['pte_proforma_price'])*$detExc['pte_proforma_num_std'],2,",",""); ?> <?php echo $detExc['pte_proforma_currency'] ?></b></span></td>
					</tr>
				</table>
			</td>
		</tr>
