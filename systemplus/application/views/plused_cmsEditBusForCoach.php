		...
		<section id="content" class="container_12 clearfix" data-sort=true>
			<div class="grid_12 profile">
				...
				<div class="header">
					...
					<div class="title">
						<h2>Edit bus for <?php echo $company["tra_cp_name"]?></h2>
					</div>
					<div class="avatar">
				...
				<div class="details grid_12">
					...
					<section>
						<table>
							<tr>
								<th>Bus name (eg. Bus 29 seater):</th><td><input type="text" style="width:300px;" name="tra_bus_name" id="tra_bus_name" class="required" value="<?php echo $bus["tra_bus_name"]?>"></td>
							</tr>
							<tr>
								<th>Seats:</th><td><input class="contastudenti" data-type="spinner" name="tra_bus_seat" id="tra_bus_seat" value="<?php echo $bus["tra_bus_seat"]?>" min="0" max="100" /></td>
							</tr>
						</table>
					</section>
					<div class="actions">
						<div class="right">
							<input id="updatebus" type="submit" value="Update bus" name=updatebus />
						</div>
					</div>	
					</form>
				</div>
