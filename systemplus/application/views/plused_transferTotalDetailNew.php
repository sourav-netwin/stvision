						...
						?>
							...
							<tbody>
								...
								<?php
									...
									while (strtotime($datecycle) <= strtotime($dateout)) {
								?>
									<td><input type="text" readonly value="<?php echo $simTransfersIn[$a][$contagiorni]["booked"];?>"></td>
								<?php
										$datecycle = date ("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
										$contagiorni++;										
									}
								...
								<?php
									...
									while (strtotime($datecycle) <= strtotime($dateout)) {
								?>
									<td><input type="text" readonly value="<?php echo $simTransfersIn[$a][$contagiorni]["nonPrenotati"];?>"></td>
								<?php
										$datecycle = date ("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
										$contagiorni++;										
									}
