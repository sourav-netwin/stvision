...
<!--				<img src="<?php // echo PLUS_ROOT ?>application/images/logo_PLU.png" border="0" style="width:560px;margin-bottom:20px;" />-->
				<img src="img/logo-light.png" border="0" style="width:200px;margin-bottom:20px;" />
			</td>
		</tr>
		<tr>
			...
			<td colspan="2">
				<table class="corpopre">
					<tr class="testapreventivo">
						<td style="width:100px;"><span>GL + PAX</span></td>
						<td style="width:380px;"><span>Description</span></td>
						<td style="text-align:right;width:80px;"><span>Cost</span></td>
					</tr>
					<tr><td colspan="3" style="height:15px;">&nbsp;</td></tr>  
					<tr>
						<td><span><?php echo $campi['tot_pax']?></span></td>
						<td>
							<span>Deposit for group leaders and students enrolled</span><br />
							<table class="detaila">
								<tr><td colspan="3" style="background-color:#000;color:#fff;"><span style="font-weight:bold;">Accomodations detail</font></td>
							<?php
							foreach($booking_acc as $single_acc){ ?>
								<tr><td align="right" style="width:20px;"><span><?php echo $single_acc["conto"]?></span></td><td><span><?php echo $single_acc["tipologia_p"]?></span></td><td><span><?php echo $single_acc["accomodation"]?></span></td></tr>
							<?php
							}
							?>
							</table>
						</td>
						<td style="text-align:right"><span><?php echo $campi['tot_pax']*$campi['valore_acconto']?> <?php echo $campi['valuta_fattura']?></span></td>
					</tr>
					<tr><td colspan="3" style="height:15px;border-bottom:1px solid #ddd;">&nbsp;</td></tr>
					<tr>
						<td colspan="2" style="text-align:right;"><span><b>Amount Due</b></span></td>
						<td style="text-align:right;"><span><b><?php echo $campi['tot_pax']*$campi['valore_acconto']?> <?php echo $campi['valuta_fattura']?></b></span></td>
					</tr>
				</table>
			</td>
		</tr>
