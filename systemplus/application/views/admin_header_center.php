...
<section id="secondary_bar">
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
		<?php 
			foreach ($center_menu as $name){						
					echo "<li><a href=\"".base_url()."index.php/payroll/admin_center/".$name['nome_centri']."\">".$name['nome_centri']."</a></li>";
		...
		<ul class="toggle">
		<li>Administrator</li>
		<?php echo "<li><a href=\"".base_url()."index.php/payroll/logout\">Logout</a></li>"; ?>
		</ul>
		<footer>
			<hr />
