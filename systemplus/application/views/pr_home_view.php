...
<?php foreach($teachers as $item): 
		...
		echo "<a href=\"".base_url()."index.php/payroll/singlecheck/".$item['id_personal']."\">Attendants Register</a> | <a href=\"".base_url()."index.php/payroll/details/".$item['id_personal']."\">Employee personal details</a>";
		echo "<hr>";
