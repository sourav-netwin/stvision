	...
	if ($locked == 'locked') {
		if ($initTemp == 'USA') {
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-us">
				...
				<tr>
					<td>The programme is inclusive of full - board accommodation, English Lessons (20 Lessons a week) and an afternoon, evening and weekend Leisure Programmes.The payment is being made<br />From Monday to Friday the students will have English lessons in the morning and afternoon and evening activities after lunch. All activities will be supervised by the group leaders and the PLUS residential staff.<br /><br /></td>
				</tr>
				<tr>
		...
		elseif ($initTemp == 'UKIR') {
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-us">
				...
				<tr>
					<td>The programme is inclusive of full - board accommodation, English lessons (15 hours lessons a week) and an afternoon, evening and weekend leisure programmes.The payment is being made<br /><br />From Monday to Friday the students will have English lessons in the mornings and some afternoons. There are planned afternoon and evening activities and weekend excursions. All activities will be supervised by the group leaders and the PLUS residential staff.<br /><br /></td>
				</tr>
				<tr>
		...
		elseif ($initTemp == 'MAL') {
			...
			<table cellpadding="0" cellspacing="0" class="grande grande-mal">
				<tr><td style="height:100px;"><img src="http://plus-ed.com/vision_ag/img/logo_plus.png" style="width: 150px; float: left" border="0" /></td>
		...
		<tr>
			<td>Type of visa for students: <?php if($initTemp == 'UKIRSTDST') {?> Short-term study visa <?php }else { ?> Standard visitor visa <?php } ?><br /><br />
				Type of visa for group leader: <?php if($initTemp == 'UKIRSTDST') {?> Short-term study visa <?php }else { ?> Standard visitor visa <?php } ?><br /><br />
...
foreach ($detSTD as $single) {
	$loop_count_STD = $loop_count_STD + 1;
	if ($single["cognome"] != "") {
			...
			if ($initTemp == 'UKIR') {
				...
				<?php 
					if(count($detSTD) != $loop_count_STD) {
				 ?>				
					<pagebreak />
				<?php 					
				}
