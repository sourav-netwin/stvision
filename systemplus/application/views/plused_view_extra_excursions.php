		...
		<section id="content" class="container_12 clearfix" data-sort=true>
			<div class="grid_12">
				<div class="box">
					...
					<div class="header">
						<h2><img class="icon" src="<?php echo base_url(); ?>img/icons/packs/fugue/16x16/table.png">Bookings<?php /*<a style="float:right;" href="<?php echo base_url(); ?>downloads/extras/guide_for_book_extra_excursions.pdf" target="_blank" title="Guide for upload list"><img src="<?php echo base_url(); ?>img/icons/packs/fugue/16x16/information-button.png" class="icon">How to book extra excursions</a> */ ?></h2>
					</div>
						...
						<table class="dynamic styled" data-filter-bar='always' data-max-items-per-page='10' data-table-tools='{"display":false}' data-data-table='{"aaSorting":[[1,"asc"]],"aoColumns":[{"bSearchable": true,"bSortable": true},{"bSearchable": true,"bSortable": true},{"bSearchable": true,"bSortable": false},{"bSearchable": true,"bSortable": false},{"bSearchable": false,"bSortable": false},{"bSearchable": false,"bSortable": false},{"bSearchable": false,"bSortable": false},{"bSearchable": false,"bSortable": false}]}'> <!-- OPTIONAL: with-prev-next -->
							...
							?>
								<tr>
									...
									<td class="center"><a data-gravity="s" class="button small grey tooltip" href="<?php echo base_url(); ?>index.php/agents/viewExtraNow/<?php echo $book["id_book"]?>/<?php echo $book["id_centro"]?>/<?php echo $book["id_year"]?>" original-title="View available extra excursions for booking <?php echo $book["id_year"]?>_<?php echo $book["id_book"]?>" style="margin-left:0;"><i class="icon-zoom-in"></i></a></td>
								</tr>
							<?php
								}
							?>
