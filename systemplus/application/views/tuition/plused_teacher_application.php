    ...
    <script>
        $(document).ready(function() {
            ...
            function buildUploadFileControl(fileTitle,fileName){
                ...
                controlHTML += "            <input type='file' class='oFiles' disabled='disabled' placeholder='other document "+num+"' name='otherFile_"+num+"' id='otherFile_"+num+"' >";
                ...
                if(fileName != '')
                    controlHTML += "            <a target='_blank' id='link_otherFile_"+num+"' data-num='"+num+"' href='<?php echo base_url().OFFICE_OTHER_FILE_PATH;?>"+fileName+"'>"+fileName+"</a>";
                else
            ...
            $( "body" ).on( "click", "#btnUpload",function(){
                var setAlert = false;
                $(".oFiles:file").each(function()
                {
                    if($(this).val() == ''){
                        setAlert = true;
                    }
                });
                if($(".oFiles:file").length == 0){
                    alert("Please click on '+ Add file' button to add upload control.");
                }
                else if(setAlert){
                    alert("Please enter file title & select file to upload and try again.");
                }
            });
                    ...
                    $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR)
                        {
                            if(typeof data.error === 'undefined')
                            {
                                ...
                                $("#link_"+thisfile).attr('href','<?php echo base_url().OFFICE_OTHER_FILE_PATH;?>'+data.file_name);
                ...
                <div class="content">
                    <form enctype="multipart/form-data" method="post" class="no_validate" id="frmTeacher" action="">
                        ...
                        <div class="row">
                                ...
                                <div class="form-data" style="margin-left: 130px;">
                                    <select class="required" id="selTeachYears" name="selTeachYears"  >
                                        ...
                                        <option <?php echo ($formData['ta_teach_years'] == '1-2 years' ? 'selected="selected"' : '');?> value="1-2 years">1-2 years</option>
                                        <option <?php echo ($formData['ta_teach_years'] == '3-5 years' ? 'selected="selected"' : '');?> value="3-5 years">3-5 years</option>
                                        <option <?php echo ($formData['ta_teach_years'] == '6-9 years' ? 'selected="selected"' : '');?> value="6-9 years">6-9 years</option>
                                        <option <?php echo ($formData['ta_teach_years'] == 'more than 10 years' ? 'selected="selected"' : '');?> value="more than 10 years">more than 10 years</option>
                                    </select>
                        ...
                        <div class="row">
                                ...
                                <div class="form-data" style="margin-left: 130px;">
                                        <input type="file" placeholder="Attach your CV" name="cvFile" id="cvFile" >
                        ...
                        <div class="row">
                                <div class="form-data" style="margin-left: 130px;">
                                    ...
                                    <input type="hidden" id="hidd_tajobadvsent" name="hidd_tajobadvsent" value="<?php echo $formData["ta_job_adv_sent"];?>" />
                                    <input class="btn btn-tuition" type="submit" id="btnSave" name="btnSave" value="Submit" />
                                    <input class="btn btn-tuition" type="reset" id="btnCancel" name="btnCancel" value="Cancel" onclick="window.location.href='<?php echo base_url();?>index.php/teachers/<?php echo ($formData["ta_job_adv_sent"] ? "profilereview" : "review" );?>'" />
                                </div>
                        </div>
                    </form>
                </div><!-- End of .content -->
