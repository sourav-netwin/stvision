...
<body class=login>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href="<?php echo base_url(); ?>index.php/users"><img src="<?php echo base_url(); ?>img/logo-light.png" alt="plus-ed.com" width="210" height="67"></a>
...
<!--			<div class="right">
	...
	<section id="login" class="container_12 clearfix">
		...
		<form action="<?php echo base_url(); ?>index.php/users/forgotpassword" method="post" class="box validate">
			...
			<?php
				...
				?>
					<div class="alert error">
						...
						<strong>Error!</strong> The entered email does not exist.
					</div>
				<?php
					}
				...
				?>
					<div class="alert success">
						<span class="icon"></span><span class="close">x</span>
						<strong>Success!</strong> We have change your password and sent it to your email box.
					</div>
				<?php
					}
				}
			?>
				...
				<div class="login-messages">
					<div class="message welcome">Enter your email address!</div>
					<div class="message failure">Invalid email address.</div>
				</div>
				...
				<div class="form-box">
					...
					<div class="row">
						...
						<div>
							<input tabindex=1 type="text" class="required email noerror" name=txtEmailAddress id=txtEmailAddress />
						</div>
					</div>
				</div><!-- End of .form-box -->
			...
			<div class="actions">
                            <div class="left"><a href="<?php echo base_url();?>index.php/users">Login</a></div>
				<div class="right">
