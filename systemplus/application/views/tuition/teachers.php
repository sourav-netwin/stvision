<?php 
	...
	<div class="row">
		<form enctype="multipart/form-data" action="<?php echo base_url().'index.php/teachers/apply';?>" method="POST" class="form-horizontal">
			...
			<div class="form-group col-lg-6">
				<label class="col-lg-2 control-label" for="txtPostCode">Postcode</label>
				<div class="col-lg-10">
					<input type="text" placeholder="Postcode" id="txtPostCode" name="txtPostCode" value="<?php echo set_value('txtPostCode',$formData['ta_postcode']);?>" class="form-control">
					<span class="error"><?php echo form_error('txtPostCode');?></span>
				</div>
			</div>								  
			<div class="form-group col-lg-6">
				<label class="col-lg-2 control-label" for="txtCounty">County</label>
				<div class="col-lg-10">
					<input type="text" placeholder="County" id="txtCounty" name="txtCounty" value="<?php echo set_value('txtCounty',$formData['ta_county']);?>" class="form-control">
					<span class="error"><?php echo form_error('txtCounty');?></span>
				</div>
			</div>								  
			<div class="form-group col-lg-6">
