...
<head>
<meta charset="utf-8">
<title>plus-ed.com | Weekly booking to be elapsed</title>
</head>
    ...
    <div style="width:100%;margin:0 ;float:left;" id="warpper_in"><!-- border:solid 1px #fab1b3; -->
    	<div class="top_header" style="background-color: #587691;padding: 10px 0 10px 10px;width:98%;max-width:800px;height:100%;float:left;">
     	...
     	<div style="width:94%;float:left;padding:3%;" class="mid_content">
            <p>Hello,</p>
<!--            <p><a href="<?php //echo base_url().'index.php/backofficecrons/downloadcsv/'.$excel_file;?>">Click here</a> to download the weekly elapsed booking.</p>-->
            <p>Please find attachment to download the weekly elapsed booking excel file.</p>     
