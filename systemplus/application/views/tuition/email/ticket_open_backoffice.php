...
<html>
    <head>
        <meta charset="utf-8">
        <title>plus-ed.com | New Ticket open</title>
    </head>
        ...
        <div style="width:100%;max-width:800px;margin:0 auto;position:relative;display:block;" id="warpper">
            <div style="width:100%;margin:0 ;float:left;" id="warpper_in"><!-- border:solid 1px #fab1b3; -->
                <div class="top_header" style="background-color: #587691;padding: 10px 0 10px 10px;width:98%;max-width:800px;height:100%;float:left;">
                    <img style="width:135px;float:left;height:auto;" src="<?php echo base_url(); ?>img/tuition/email_logo.png" alt="Logo Image"/>
                </div>
                <div style="width:94%;float:left;padding:3%;" class="mid_content">
                    <p>Hello</p>
                    <p>A new ticket has been opened for you, please check this ticket on below link.</p>
                    <a href="<?php echo base_url() . 'index.php/backoffice/recapTicket'; ?>">Click here</a>


                    <p>Plus Sales Office</p>
                </div>
                <div style="font-size: 13px;">
                    This is an automated message, please do not reply at this email.
                </div>
