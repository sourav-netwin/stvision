...
<body class=login>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href="<?php echo base_url(); ?>index.php/backofice"><img src="<?php echo base_url(); ?>img/logo-light.png" alt="plus-ed.com" width="210" height="67"></a>
...
<!--			<div class="right">
	...
	<section id="login" class="container_12 clearfix">
		...
		<form action="<?php echo base_url(); ?>index.php/users/login" method="post" class="box validate">
...
<!--							<small>Or email address</small>-->
						...
						<div>
							<input tabindex=1 type="text" class="required email noerror" name=login_name id=login_name />
						</div>
					</div>
					...
					<div class="row">
						<label for="login_pw">
							...
							<small><a href="<?php echo base_url();?>index.php/users/forgotpassword" id="">Forgot it?</a></small>
						</label>
						<div>
