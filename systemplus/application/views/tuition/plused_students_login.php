...
<!--				<li><a href="#"><span class="icon icon-home"></span></a></li>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href="<?php echo base_url(); ?>index.php/students"><img src="<?php echo base_url(); ?>img/logo-light.png" alt="plus-ed.com" width="210" height="67"></a>
...
<!--			<div class="right">
	...
	<section id="login" class="container_12 clearfix">
		...
		<form id="frmLogin" action="<?php echo base_url(); ?>index.php/students/login" method="post" class="box validate login-phone">
