...
//                    },
            ...
            <?php if($edit_id){?>
                ...
                $("#selApplicant").trigger("liszt:updated");
            <?php }else{?>
                $( "body" ).on( "change", "#selApplicant", function() {
                    var applicantId = $(this).val();
                    $.post( SITE_PATH + "contract/getApplicantProfile",{'applicantId':applicantId}, function( data ) {
                        if(parseInt(data.status))
                        {
                            ...
                            $("#selPostCode").trigger("liszt:updated");
                            $("#selCountry").trigger("liszt:updated");
                        }
                        else
                        {
                            $("#txtEmail").val('');
            ...
            <div class="box">
                ...
                <div class="content">
                    <form method="post" id="frmTeacher" action="">
                            ...
                            ?>
                        <div class="row">
                            <label for="selApplicant" style="width: 115px;">
                                <strong>Applicant</strong>
                            </label>
                            <div class="form-data" style="margin-left: 130px;">
                                <select id="selApplicant" name="selApplicant"   >
                        ...
                        <div class="row">
                                ...
                                <div class="form-data" style="margin-left: 130px;">
                                        <input type="text" class="respon-width"  placeholder="Email" id="txtEmail" name="txtEmail" value="<?php echo set_value('txtEmail',$formData['txtEmail']);?>" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-data" style="width:100%;">
                                <div style="float: left;width: 25.233% !important;"><span class="text">From Date: </span>
                                <input type="text" style="width:65px;" id="txtConFromDate" name="fd" value="<?php echo (!empty($formData['txtConFromDate']) ? date('d/m/Y', strtotime($formData['txtConFromDate'])) : '') ?>"   />
                                </div>
                                <div style="float: left;margin-left:4%;width: 25.233% !important;"><span style="margin-left:1.2%;" class="text">To Date: </span>
                                <input style="width:65px;" type="text" id="txtConToDate" name="td" if="<?php echo $formData['txtConToDate'] ?>" value="<?php echo (!empty($formData['txtConToDate']) ? date('d/m/Y', strtotime($formData['txtConToDate'])) : ''); ?>"  /> 
                                </div>
                                <div style="clear: both;" for="txtConFromDate" generated="true" class="error"></div>
                                <div style="clear: both;" for="txtConToDate" generated="true" class="error"></div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <label for="txtSalary" style="width: 115px;">
                                <strong>Salary</strong>
                            </label>
                            <div class="form-data" style="margin-left: 130px;">
                                <input type="text" id="txtSalary" name="txtSalary"   onkeypress="return keyRestrict(event,'1234567890.');"  style="width:100px;"  maxlength="13" value="<?php echo set_value('txtSalary', $formData['txtSalary']); ?>" >
                        ...
                        <div class="row">
                            <label for="selResidential" style="width: 115px;">
                                <strong>Residential</strong>
                            </label>
                            <div class="form-data" style="margin-left: 130px;">
                                <select   id="selResidential" name="selResidential"  >
                        ...
                        <div class="row">
                            <label for="txtHoursPerWeek" style="width: 115px;">
                                <strong>Hours/week</strong>
                            </label>
                            <div class="form-data" style="margin-left: 130px;">
                                <input type="text" id="txtHoursPerWeek" name="txtHoursPerWeek"   onkeypress="return keyRestrict(event,'1234567890');"  style="width:75px;"  maxlength="6" value="<?php echo set_value('txtHoursPerWeek', $formData['txtHoursPerWeek']); ?>" >
                                <div class="error"><?php echo form_error('txtHoursPerWeek'); ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <label for="selExtraActivity" style="width: 115px;">
                                <strong>Extra Activity</strong>
                            </label>
                            <div class="form-data" style="margin-left: 130px;">
                                <select class="" id="selExtraActivity" name="selExtraActivity"  >
                        ...
                        <div class="row">
                            <label for="rdoReturnee" style="width: 115px;">
                        ...
                        <div class="row">
                            <label for="rdoContractSigned" style="width: 115px;">
                        ...
                        <div class="row">
                                ...
                                <div class="form-data" style="margin-left: 130px;">
                                        <textarea rows="3" class="  respon-width" placeholder="Address" id="txtAddress" name="txtAddress"><?php echo set_value('txtAddress',$formData['txtAddress']);?></textarea>
                        ...
                        <div class="row">
                                ...
                                <div class="form-data" style="margin-left: 130px;">
                                        <input type="text" class="  respon-width" placeholder="City" id="txtCity" name="txtCity" value="<?php echo set_value('txtCity',$formData['txtCity']);?>" >
