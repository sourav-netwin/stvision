		...
		<section id="content" class="container_12 clearfix" data-sort=true>
			...
			<div class="grid_4">
				<div class="box">
					...
					<div class="content">
							<form style="margin:10px;" id="box_status" name="box_status" action="<?php echo base_url(); ?>index.php/backoffice/overviewBookings" method="post">  
				...
				<div class="box">
					...
					<div class="content">
						...
						<table class="styled" data-table-tools='{"display":false}'> <!-- OPTIONAL: with-prev-next -->
							...
							?>
								<tr>
									<td class="center"><a style="width:70px;float:left;" href="javascript:void(0);" id="dialog_modal_btn_<?php echo $book["id_year"]?>_<?php echo $book["id_book"]?>" class="dialogbtn">[View]</a> <?php echo $book["id_year"]?>_<?php echo $book["id_book"]?><br><?php echo $book["weeks"]?>w / <?php echo $book["tot_pax"]?> pax
...
<?php
				...
				<?php
					if($book['saldo_versato'] > 0) {?>
						<tr><td class="pdf-create-payed" style="text-align:center;float:left;"><a target="_blank" href= "<?php echo base_url(); ?>index.php/gestione_centri/invoice_pdf_no_saldo/<?php echo $book ['id_book']; ?>" title="Print Final Invoice"><span>Print Final Invoice</span></a></td></tr>
					...
					<?php
						...
						if($book['print_2'] > 0) {?>	
						<tr><td class="pdf-create-printed" style="text-align:center;float:left;"><a target="_blank" href= "<?php echo base_url(); ?>index.php/gestione_centri/invoice_pdf_no_saldo/<?php echo $book ['id_book']; ?>" title="Print Final Invoice"><span>Print Final Invoice</span></a></td></tr>
						<tr><td style="text-align:center;"><input class="edit-extragl" type="text" name="extragl-<?php echo $book['id']?>" id="extragl-<?php echo $book ['id_book']; ?>" value="<?php echo $book['extragl']*1; ?>" /><span style="display:block"><?php echo $book['valuta']?></span></td></tr>
						<?php
						}else{?>
						<tr><td class="pdf-create" style="text-align:center;float:left;"><a target="_blank" href= "<?php echo base_url(); ?>index.php/gestione_centri/invoice_pdf_no_saldo/<?php echo $book ['id_book']; ?>" title="Print Final Invoice"><span>Print Final Invoice</span></a></td></tr>
						<tr><td style="text-align:center;"><input class="edit-extragl" type="text" name="extragl-<?php echo $book ['id_book']; ?>" id="extragl-<?php echo $book ['id_book']; ?>" value="<?php echo $book['extragl']*1; ?>" /><span style="display:block"><?php echo $book['valuta']?></span></td></tr>
						<?php
						}?>
					<?php
					}?>
