			...
			<div class="grid_12 profile">
				...
				<div class="details grid_12">
					...
					<section>
						<table>
							<tr>
								<th style="width:150px;">Attraction:</th><td><input type="text" style="width:300px;" name="pat_name" id="pat_name"  value="<?php echo $CC['pat_name'] ?>"></td>
							</tr>
							<tr>
							...
							<tr>
								<th style="width:150px;">Entertainment Group</th><td><input type="text" style="width:300px;" name="pat_entertainment_group" id="pat_entertainment_group" class="required" value="<?php echo $CC['pat_entertainment_group'] ?>"></td>
							</tr>
							<tr>
								<th style="width:150px;">Students price:</th><td><input type="text" style="width:300px;" name="pat_student_price" id="pat_student_price" class="required" value="<?php echo $CC['pat_student_price'] ?>"></td>
							</tr>	
							<tr>
								<th style="width:150px;">Adults price:</th><td><input type="text" style="width:300px;" name="pat_adult_price" id="pat_adult_price" class="required" value="<?php echo $CC['pat_adult_price'] ?>"></td>
							</tr>
							<tr>
							...
							<tr>
								<th style="width:150px;">Address:</th><td><input type="text" style="width:450px;" name="pat_address" id="pat_address" class="required" value="<?php echo $CC['pat_address'] ?>"></td>
							</tr>
							<tr>
							...
							<tr>
								<th style="width:150px;">Description</th><td><textarea style="width:600px;height:400px;" name="pat_desc" id="pat_desc" class="editor required"><?php echo $CC['pat_desc'] ?></textarea></td>
							</tr>
							<tr>
								<th style="width:150px;">Opening time</th><td><textarea style="width:600px;height:400px;" name="pat_opening_time" id="pat_opening_time" class="editor required"><?php echo $CC['pat_opening_time'] ?></textarea></td>
							</tr>	
							<tr>
								<th style="width:150px;">Notes</th><td><textarea style="width:600px;height:400px;" name="pat_notes_1" id="pat_notes_1" class="editor required"><?php echo $CC['pat_notes_1'] ?></textarea></td>
							</tr>									
							<tr>
								<th style="width:150px;">Phone number:</th><td><input type="text" style="width:300px;" name="pat_phone" id="pat_phone" class="required" value="<?php echo $CC['pat_phone'] ?>"></td>
							</tr>
							<tr>
								<th style="width:150px;">Email:</th><td><input type="text" style="width:300px;" name="pat_email" id="pat_email" value="<?php echo $CC['pat_email'] ?>"></td>
							</tr>	
							<tr>
								<th style="width:150px;">Website:</th><td><input type="text" style="width:300px;" name="pat_website" id="pat_website" value="<?php echo $CC['pat_website'] ?>"></td>
							</tr>								
						</table>					
					</section>
					<div class="actions">
						<div class="right">
							<input id="modprofile" type="submit" value="Update attraction details" name=modprofile />
						</div>
					</div>	
				</div>				
