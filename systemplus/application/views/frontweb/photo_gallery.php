...
<?php
					...
					echo form_open_multipart('frontweb/junior_centre/photo_gallery_add/'.$juniorCentreId , $formAttribute);
?>
...
<script type = "text/javascript">
	...
	$(document).ready(function(){
		...
		$('.changeSequence').on('change' , function(){
			...
			$.ajax({
				url : '<?php echo base_url(); ?>index.php/frontweb/junior_centre/update_sequence',
