...
<script src="<?php echo LTE; ?>frontweb/custom/junior_ministay.js?v=0.3"></script>
				...
				<div class="box-header col-sm-12">
					<div class="row">
						<div class="col-sm-6 btn-create">
							<a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/frontweb/junior_ministay/add_edit"><i class="fa fa-plus" aria-hidden="true"></i> Add junior mini stay</a>
						</div>
...
<?php
			...
			echo form_open_multipart('frontweb/junior_ministay/add_video_gallery_management' , $formAttribute);
?>
				<input type="hidden" name="videoJuniorMiniStayId" id="videoJuniorMiniStayId">
...
?>
							<small style="display:block">
								( Note: Only JPG|JPEG|PNG images are allowed <br> &amp; Image dimension should be greater or equal to <?php echo MINISTAY_VIDEO_GALLERY_WIDTH; ?> X <?php echo MINISTAY_VIDEO_GALLERY_HEIGHT; ?> pixel )
							</small>
...
?>
				...
				<input type="hidden" name="juniorMiniStayId" id="juniorMiniStayId">
				<div class="modal-body">
					<div class="form-group">
...
<?php
			...
			echo form_open_multipart('' , $formAttribute);
?>
				<input type="hidden" name="dateJuniorMiniStayId" id="dateJuniorMiniStayId">
...
<?php
							for($i  = 1 ; $i <= 5 ; $i++)
							{
								echo $i.' <input class="datesWeek" type="checkbox" name="week[]" value="'.$i.'" />'.nbs(10);
							}
?>
...
<?php
			...
			echo form_open_multipart('' , $formAttribute);
?>
				<input type="hidden" name="internationalMixJuniorMiniStayId" id="internationalMixJuniorMiniStayId">
				<div class="modal-body">
					<div class="form-group">
...
?>
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
<?php
							echo form_dropdown('extra_section_id' , getExtraSection(2) , '' , 'class="form-control" id="extra_section_id"');
?>
						</div>
					</div>
					<div class="form-group">
