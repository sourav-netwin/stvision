...
<script src="<?php echo LTE; ?>frontweb/custom/program_course.js?v=1.1"></script>
				...
				<div class="box-header col-sm-12">
					<div class="row">
						<div class="col-sm-6 btn-create">
							<a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/frontweb/program_course/add_edit"><i class="fa fa-plus" aria-hidden="true"></i> Add course program</a>
						</div>
