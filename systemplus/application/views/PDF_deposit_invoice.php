			...
			<td colspan="2">
				<table class="corpopre">
					...
					<tr>
						...
						<td>
							<span>Deposit received for group leaders and students enrolled</span><br />
							<table class="detaila">
						...
						<td style="text-align:right"><span><?php echo $campi['acconto_versato']?> <?php echo $campi['valuta_fattura']?></span></td>
					</tr>
					...
					<tr>
						...
						<td style="text-align:right;"><span><b><?php echo $campi['acconto_versato']?> <?php echo $campi['valuta_fattura']?></b></span></td>
					</tr>
				</table>
			</td>
		</tr>
