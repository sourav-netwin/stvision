			...
			<h1 class="blu"><?=$heading;?></h1>
				...
				<table width="100%" cellspacing="12" cellpadding="12" >
									<tr><td id="all" colspan="2"><h4>SETUP STATUS - <?php echo $nome['title'] . "&nbsp;" . $nome['nome'] . "&nbsp;" . $nome['cognome']; ?></h4></td></tr>
									 ...
									 <tr><td><h5>Date Start</h5></td></tr><tr><td><input type="text" id="datepicker_start" name="date_start" value="<? echo $nome['date_start']?>"></td></tr>
									 <tr><td><h5>Date End</h5></td></tr><tr><td><input type="text" id="datepicker_end" name="date_end" value="<? echo $nome['date_end']?>"></td></tr>
									 <tr><td><h5>Weekly Salary</h5></td></tr><tr><td><input type="text" name="salary" value="<? echo $nome['salary']?>"></td></tr>
									 ...
									 <tr>
										<td >
										<textarea name="comment" style="background-color:#FBF6D0" rows="6" cols="45"><? echo $nome['comment'] ?></textarea>		
										</td>
									 </tr>
									
									  <tr><td colspan="2" align="right"><input type="submit" value="Submit" /></td></tr>
									  </form>
									  <tr><td><?php echo "<a href=\"". base_url() ."index.php/cms/delete_candidate/" . $this->uri->segment(3) . "\">" ?>Delete this profile?</a></td></tr>
