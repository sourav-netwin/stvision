	...
	<?php $this->load->view('agenti_tab');?>
		...
		<div id="middle" >
            ...
            <fieldset class="confirm">
                    <h4 class="msg_confirm">Excursion not found...</h4>
                       <p>Try again, click: <a href="<?php echo base_url(); ?>index.php/agenti/search_by_agency" class="confirm_link">your booking</a></p>
            </fieldset>       
