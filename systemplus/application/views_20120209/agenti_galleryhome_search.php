	...
	<?php $this->load->view('agenti_tab');?>
		<div id="left">
			<div class="left_menu" style="margin:28px 0 0 0">
		        ...
		        <blockquote>
		          <p><span class="grigio"><strong>Just click</strong> on the Categories you<br>require and select <br>the images you prefer.<br>
	              Then simply click<br>
	              “download” and the image
	              will be <br>automatically
	              transferred <br>to your computer.</span></p>
	          </blockquote>
		  </div>
		...
		<div style="display:block; clear:both; background-color:#eee; margin:10px 0 0 0; width:680px;"></div>	
		</div>
