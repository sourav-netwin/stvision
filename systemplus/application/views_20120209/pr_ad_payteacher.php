	...
	<div id="box_radius">
			...
			foreach($teachers as $key => $item)
				{	
					...
					if($hourday==0){
						...
						echo "<td><strong>On budget: </strong>".$hourday."</td><td>".$temphourday."</td>";
					}elseif($hourday>0){
						$temphourday=$temphourday+($hourday+3);
						echo "<td><strong>Over budget:  " . $hourday . "</strong></td><td>".$temphourday."</td>";
					}elseif($hourday<0){
						$temphourday=$temphourday+($hourday+3);
						
						echo "<td><strong>Under budget:  " . $hourday . "</strong></td><td>".$temphourday."</td>";
					}
					echo "</tr>";
				...
				echo "</td></tr><tr><td><strong>Holiday Pay Sleep:</strong> " . number_format($actualcost * 10.77/100,2) . "</td></tr>";
				?>
			...
			<?php
				...
				echo "<div class=\"module_content\">";
					...
					echo "<div style=\"display:block; float:left; min-height:280px; width:50%; margin:4px; padding:10px; background-color:#fff\">";
