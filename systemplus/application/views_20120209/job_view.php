...
<div id="container">
		...
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/1", " Teaching");?> </div>
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/3", " Summer Job");?> </div>
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/2", " Marketing");?> </div>
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/4", " Operation");?> </div>
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/5", " Finance");?> </div>
		<div class="boxsilver_right"><img align="middle" src="<?php echo base_url(); ?>images/folder.png"><? echo anchor("job/cat/7", " Sales");?> </div>
		</div>
