		...
		<div id="middle" >
               <form name="step3"  action="<?php echo base_url(); ?>index.php/agenti/insert_excursions"  method="post" >
                ...
                <br>
                   ...
                   <br>
                    <label class="dark_blue">Cost: </label>

                        <?php 
             foreach($prenotazione as $excursion){
                 $check=true;
                        if($excursion['fleet_14']>=$_POST['tot_pax']){
                                     echo "<p> &pound; ".ceil($excursion['price_14']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_16']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_24']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_25']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_28']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_29']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_33']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_35']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_38']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_41']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_45']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_49']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_50']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_51']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_53']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_57']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_70']*(1+16.5/100))."</p>";
                                     ...
                                     echo "<p> &pound; ".ceil($excursion['price_75']*(1+16.5/100))."</p>";
