...
<div id="container" >
	...
	<?php $this->load->view('agenti_tab');?>
		...
		<div id="middle" >  
                        ...
                        ?>
                           <?php 
                                   ...
                                   if($item ['confirm_in']== 'NO'){ 
                                       echo "<p class=\"info\"><a href=\"".base_url()."index.php/agenti/confirm_datain/".$item ['id']."\"  onClick=\"return confirm('Do you confim the transfer?'); \">";
                                       echo "<img src=\"".base_url()."images/not.png\" alt=\"not\"/>";
                                       echo "</a></p>";  
                                   }  else{
                                      echo "<p class=\"info\">CONFIRMED</p>"; 
                                   }
                                   ...
                                   if($item['n_volo_arrivo']!=''){
                                      ...
                                      echo "<div class=\"details\">FIRST MEAL: </div>";
                                      echo "<p class=\"info\">".$item['arrival_service']."</p>";
                            ?>
                                <br>
                           ...
                           <?php 
                                      ...
                                      echo "<div class=\"details\">TRANSFER: </div>";
                                   if($item ['confirm_in']== 'NO'){ 
                                       echo "<p class=\"info\"><a href=\"".base_url()."index.php/agenti/confirm_dataout/".$item ['id']."\"  onClick=\"return confirm('Do you confim the transfer?');\">";
                                       echo "<img src=\"".base_url()."images/not.png\" alt=\"not\"/>";
                                       echo "</a></p>";  
                                   }  else{
                                        echo "<p class=\"info\">CONFIRMED</p>"; 
                                   ...
                                   if($item['n_volo_arrivo']!=''){
                                      ...
                                      echo "<div class=\"details\">LAST MEAL: </div>";
                                      echo "<p class=\"info\">".$item['partenza_service']."</p>";      
                            ?>  
                        </fieldset>     
                       <?php
                            }
                   ...
                   <?php  
                        ...
                        foreach($excursion_pack as $key=>$item){
                         ...
                         if($item['excursion_included_1_full'] != 'None'){
                            echo  "<div class=\"details_pack\"> - </div>"; 
                            echo "<p class=\"info\">".$item['excursion_included_1_full']."</p>";
                         }elseif($item['excursion_included_2_full'] != 'None'){
                             echo  "<div class=\"details_pack\"> - </div>"; 
                             echo "<p class=\"info\">".$item['excursion_included_2_full']."</p>"; 
                         }elseif($item['excursion_included_3_full'] != 'None'){
                             echo  "<div class=\"details_pack\"> - </div>";
                             echo "<p class=\"info\">".$item['excursion_included_3_full']."</p>";
                         }  elseif(($item['excursion_included_1_half'] == 'None') && ($item['excursion_included_2_half'] == 'None') && ($item['excursion_included_3_half'] == 'None')){
                            echo "No Excursion";
                         }
                        ...
                        echo  "<div>";
                            ...
                            if($item['excursion_included_1_half'] != 'None'){
                            echo  "<div class=\"details_pack\"> - </div>"; 
                            echo "<p class=\"info\">".$item['excursion_included_1_half']."</p>";
                         }  elseif($item['excursion_included_2_half'] != 'None'){
                             echo  "<div class=\"details_pack\"> - </div>"; 
                             echo "<p class=\"info\">".$item['excursion_included_2_half']."</p>"; 
                         }elseif($item['excursion_included_3_half'] != 'None'){
                             echo  "<div class=\"details_pack\"> - </div>";
                             echo "<p class=\"info\">".$item['excursion_included_3_half']."</p>";
                         }elseif(($item['excursion_included_1_half'] == 'None') && ($item['excursion_included_2_half'] == 'None') && ($item['excursion_included_3_half'] == 'None')){
                             echo "No Excursion";
                         }
                  ...
                  ?>      
                        ...
                        <fieldset>
                            <?php
                                ...
                                if($transfer != null){
                                           echo  "<div>";
                                           echo  "<h1>Airport Transfer: </h1><br/>";
                                           echo  "</div>";
                                        ...
                                        foreach ($transfer as $tra){
                                            ...
                                            echo  "<div>";
                                               ...
                                               echo "<div class=\"details\">Price: </div>";
                                                   ...
                                                   echo "<p class=\"info\">";
                                                   echo "<a href=\"". base_url()."index.php/agenti/delete_excursion/".$tra['id'] ."\"  onClick=\"return confirm('Do you confim the transfer?');\">";
                                           ...
                                           $index++;
                                               ...
                                               echo  "<div>";
                                               echo  "<h1> No requested airport: </h1><br/>";
                                               echo  "</div>";
                                        }                            
                            ?>
                        </fieldset>
                            ...
                            <fieldset>
                                    ...
                                    if($excursion != null){
                                           ...
                                           echo  "<div>";
                                           echo  "<h1>Excursions full day: </h1><br/>";
                                           echo  "</div>";
                                        ...
                                        foreach($excursion as $ex){
                                               ...
                                               echo  "<div>";
                                               echo  "<h1> No excursions full day requested: </h1><br/>";
                                               echo  "</div>";
                                        } 
                                    ?>
  ...
  <fieldset>
                                    ...
                                    if($excursion_half != null){
                                           ...
                                           echo  "<div>";
                                           echo  "<h1>Excursions half day: </h1><br/>";
                                           echo  "</div>";
                                        ...
                                        foreach($excursion_half as $ex){
                                               ...
                                               echo  "<div>";
                                               echo  "<h1> No excursions half day requested: </h1><br/>";
                                               echo  "</div>";
                                        } 
                                    ?>
                            </fieldset>                        
