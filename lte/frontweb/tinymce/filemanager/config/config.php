...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => (in_array($_SERVER['HTTP_HOST'], $localServerNames) ? '/stvision/vision/uploads/tinymce/' : '/vision_ag/uploads/tinymce/'),
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../../../uploads/tinymce_thumb/thumbs/',
